...
type CameraAimAssistPriorities struct {
	...
	// BlockTags is a list of priorities for specific block tag identifiers.
...
type CameraAimAssistPreset struct {
	...
	// BlockTagExclusions is a list of block tag identifiers that should be ignored by the aim assist.
