...
type SpawnParticleEffect struct {
	...
	Dimension byte
	// EntityUniqueID is the unique ID of the entity that the spawned particle may be associated with. For
	// a particle that isn't associated with an entity, this should be set to -1.
