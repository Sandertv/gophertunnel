...
type DataStoreUpdate struct {
	...
	Data any
	// PropertyUpdateCount The number of times this property has updated. Does not increment unless the entire property updates
	PropertyUpdateCount uint32
	// PathUpdateCount The number of times this path has updated. Resets if the entire property has changed.
