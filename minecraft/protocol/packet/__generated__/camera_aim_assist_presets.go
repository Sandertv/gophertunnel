...
type CameraAimAssistPresetExclusionDefinition struct {
	...
	BlockTags []string
	// EntityTypeFamilies Optional. List of entity type families to exclude from aim assist targeting.
...
func (x *CameraAimAssistPresetExclusionDefinition) Marshal(r protocol.IO) {
	...
	protocol.FuncSlice(r, &x.EntityTypeFamilies, r.String)
}
...
type CameraAimAssistCategoryPriorities struct {
	...
	BlockTags any
	// EntityTypeFamilies Optional. Map of Entity type families to Aim-Assist targeting priority. Larger numbers have greater priority.
	EntityTypeFamilies any
...
func (x *CameraAimAssistCategoryPriorities) Marshal(r protocol.IO) {
	...
	// TODO: EntityTypeFamilies - unknown additionalProperties structure
