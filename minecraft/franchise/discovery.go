...
// Environment represents an environment for Discovery in Minecraft-related services. It is used to define a struct type to be used
// in [Discovery.Environment]. A 'serviceUri' field is typically included as the primary endpoint for the service.
