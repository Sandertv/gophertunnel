...
type Dialer struct {
	...
	// ResourcePackDownload controls how many resource pack chunk requests may be in flight while a Dialer
	// downloads a pack. Values below one use the vanilla default of 100.
