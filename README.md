...
Run `make lint` to check formatting and code quality. It downloads the pinned golangci-lint
release binary once into `.bin/`. CI uses the same version and configuration.
